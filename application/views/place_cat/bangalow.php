                    ...
                    <div class="thumbnail card">
                        ...
                        <div class="caption card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <a href="<?php echo base_url('index.php/Place_Controller/P_Bungalow2/'.$row->place_id);?>"class="btn btn-primary text-white py-2 mr-3" style="align:center">More Details..</a>
                                </div>
                            </div>
                        </div>
                    </div>
